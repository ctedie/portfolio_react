...
import pinceau from '../assets/img/brush.svg'
import balise from '../assets/img/code-slash.svg'
import loupe from '../assets/img/search.svg'
function Services() {
  ...
  return (
    <>
      ...
      <TitrePage titre="Mon offre de services" description="Voici les prestations sur lesquelles je peux intervenir" />

      <div className='d-flex justify-content-center flex-wrap gap-4 m-4'> 
        <ItemService logo={pinceau} alt="UX Design" title="UX Design" 
        ...
        <ItemService logo={balise} alt="Développement web" title="Développement web" 
        ...
        <ItemService logo={loupe} alt="Référencement" title="Référencement" 
