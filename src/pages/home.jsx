...
function Home() {
  ...
  return (
    <>
      ...
      <div className='w-100'><img src={imagePrincipale} alt="photo principale" /></div>
      <div className='container border p-4 justify-content-between align-items-start gap-4 my-4 d-flex'>
        <div className=' w-50'>
          <h2 className='border-bottom border-2 border-primary'>À propos</h2>
          {/* <div ><img className='infos__photo' src={photoJohn} alt="photo de John Doe" /></div> */}
        ...
        <div className='competences w-50 d-flex flex-column' >
          ...
          <p className='labelProgressBar mt-1 mt-0'>CSS 80%</p>
